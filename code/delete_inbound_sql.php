...
try{
	...
	$sql = "delete from user_inbound where id = ";
	...
	echo "<form method=\"post\" action=\"/delete_inbound_option.php\">";
	echo "<input type=\"submit\" value=\"Go back to delete_inbound_option\">";
	echo "</form>";
