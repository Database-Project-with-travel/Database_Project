...
try{	
    session_start();
    echo "請點擊想要執行的類別 <br>";
    echo "<form method=\"post\" action = \"/midpoint_select_with_user_inbound.php\">";
    echo "<input type=\"radio\" name =\"type\" value=\"age\"> 年齡  &nbsp";
    echo "<input type=\"radio\" name =\"type\" value=\"chinese\"> 華僑/外籍 &nbsp";   
    echo "<input type=\"radio\" name =\"type\" value=\"gender\"> 性別 &nbsp";
    echo "<input type=\"radio\" name =\"type\" value=\"occupation\"> 職業 &nbsp";
    echo "<input type=\"radio\" name =\"type\" value=\"purpose\"> 來臺原因 &nbsp";
