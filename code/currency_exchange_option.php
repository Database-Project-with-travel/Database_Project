...
try{
	...
	echo "<form method=\"post\" action=\"/currency_exchange_sql.php\">";
	...
	$stmt = $conn->prepare("select distinct 幣別 from country_currency where 幣別 <> '新台幣';");
	$stmt->execute();
