...
try{
	...
	echo "<form method=\"post\" action=\"/insert_inbound_sql.php\">";
	...
	echo "請選擇華僑／外籍：<br>";
	echo "<input type=\"radio\" name =\"chinese\" value=\"華僑\"> 華僑 &nbsp";
	echo "<input type=\"radio\" name =\"chinese\" value=\"外籍\"> 外籍 <br><br>";
	...
	foreach($result as $row){
		foreach($row as $k => $v)
		{
			if($v == "" || $k == "年" || $k == "月" || $k == "居住地")
				continue;
			echo "<input type=\"radio\" name=\"occupation\" value=\"$k\">$k";
			echo "&nbsp";
		}
	}
	echo "<br><br>";
	...
	foreach($result as $row){
		foreach($row as $k => $v)
		{
			if($v == "" || $k == "年" || $k == "月" || $k == "居住地")
				continue;
			echo "<input type=\"radio\" name=\"purpose\" value=\"$k\">$k";
			echo "&nbsp";
		}
	}
	echo "<br><br>";
