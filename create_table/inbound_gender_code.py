print("create table inbound_gender(\n",
    "年 int NOT NULL,\n",
	"月 int NOT NULL,\n",
...
for names in country_names:
    print("load data local infile './data/Inbound_Gender.csv'",
    "into table inbound_gender\n",
    "character set utf8\n",
    ...
    "set 居住地 = '",names,"', 男=@col",i,",女=@col",i+1,";", sep="")
    i = i+2
print("\ndelete from inbound_gender where 年 = 0;")
