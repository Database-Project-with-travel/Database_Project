print("create table outbound_gender(\n",
    "年 int NOT NULL,\n",
	"月 int NOT NULL,\n",
...
");",
"\n\n",
"create trigger drop_comma before insert on outbound_gender\n",
	"for each row\n",
		"set new.男 = replace(new.男,',',''),\n",
		"new.女 = replace(new.女,',','');\n"
,sep="")
print()
...
for names in country_names:
    print("load data local infile './data/Outbound_Gender.csv'",
    "into table outbound_gender\n",
    "character set utf8\n",
    ...
    "set 國家名稱 = '",names,"', 男=@col",i,",女=@col",i+1,";", sep="")
    i = i+2
print("\ndelete from outbound_gender where 年 = 0;")
print("alter table outbound_gender modify 男 int;")
print("alter table outbound_gender modify 女 int;")
