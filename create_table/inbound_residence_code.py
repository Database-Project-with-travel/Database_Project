print("create table inbound_residence(\n",
    "年 int NOT NULL,\n",
	"月 int NOT NULL,\n",
...
for names in country_names:
    print("load data local infile './data/Inbound_Residence.csv'",
    "into table inbound_residence\n",
    "character set utf8\n",
    ...
    "set 居住地 = '",names,"', 人數=@col",i,";", sep="")
    i = i+1
print("\ndelete from inbound_residence where 年 = 0;")
